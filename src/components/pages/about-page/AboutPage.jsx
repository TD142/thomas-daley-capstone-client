      ...
      <main>
        <section className="about__container">
          ...
          <p className="about__text">
            Omega is an exporation in chance. The starting blocks of creation
            have been laid by the artist, Prayer, however it is down to the
            listener to create the music.
          </p>
        </section>
